...
export function EnvironmentDetailPage() {
  ...
  return <>
    ...
    <section className="project-hq-actions"><Button onClick={() => { setForm(emptyObject); setMetadataText("{}"); setEditingId(null); setShowForm(true); }}>+ Registra oggetto</Button></section>
